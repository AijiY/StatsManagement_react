...
import {
  ...
  getCurrentSeason,
  getPlayersByClub,
  getPlayersSeasonStatsByClub,
} from "../apis/GetMappings.js";
  ...
  return (
    <div>
      <nav>
        ...
        <br /> {/* 改行 */}
        {/* ClubsPageに戻るリンク */}
        <Link to={`/countries/${countryId}/leagues/${leagueId}/clubs`}>
          Back to Clubs
        </Link>
      </nav>
              ...
              <tbody>
                {players.map((player) => (
                  <tr key={player.id}>
                    ...
                    <td className="text">
                      <Link
                        to={`/countries/${countryId}/leagues/${leagueId}/clubs/${clubId}/players/${player.id}`}
                      >
                        {player.name}
                      </Link>
                    </td>
                    ...
                    <td className="center">
                      <button
                        onClick={() => navigate(`/patch-player/${player.id}`)}
                      >
                        Go
                      </button>
                    </td>
                    <td className="center">
                      <button
                        onClick={() =>
                          navigate(`/transfer-player/${player.id}`)
                        }
                      >
                        Go
                      </button>
                    ...
                    <td className="center">
                      <button
                        onClick={() =>
                          navigate(`/make-player-free/${player.id}`)
                        }
                      >
                        Go
                      </button>
