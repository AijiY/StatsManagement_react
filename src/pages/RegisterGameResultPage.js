        ...
        <form onSubmit={handleForSubmit}>
          ...
          <aside>
            ...
            {homeClubId && awayClubId && (
              <div>
                <p className="consecutive-paragraphs">
                  ※If a substitute player enters the game after 90 minutes,
                </p>
                <p className="consecutive-paragraphs">
                  ・For players who were substituted off, calculate their
                  playing time assuming they finished at 90 minutes.
                </p>
                <p className="consecutive-paragraphs">
                  ・For substitute players entering the game, record their
                  playing time as 1 minute.
                </p>
                <br /> {/* 改行 */}
              </div>
            )}
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th>
                        <img src={assistsIcon} alt="Assists" className="icon" />
                      </th>
                      <th>O.G.</th>
                      <th>
                        <img src={minutesIcon} alt="Minutes" className="icon" />
                      </th>
                      <th>
                        <img
                          src={yellowCardsIcon}
                      ...
                      <tr key={player.id}>
                        ...
                        <td className="center">
                          <input
                            ...
                            name="starter"
                            onChange={(e) =>
                              handleInputChange(e, "home", player.id, "starter")
                            }
                          />
                        </td>
                        <td>
                          <input
                            ...
                            name="goals"
                            onChange={(e) =>
                              handleInputChange(e, "home", player.id, "goals")
                            }
                            className="stats-input"
                          />
                        </td>
                        <td>
                          <input
                            ...
                            name="assists"
                            onChange={(e) =>
                              handleInputChange(e, "home", player.id, "assists")
                            }
                            className="stats-input"
                          />
                        </td>
                        ...
                        <td>
                          <input
                            ...
                            name="minutes"
                            onChange={(e) =>
                              handleInputChange(e, "home", player.id, "minutes")
                            }
                            className="minutes-input"
                            list="minutes-options"
                          />
                        </td>
                      ...
                      <tr key={player.id}>
                        ...
                        <td className="center">
                          <input
                            ...
                            name="starter"
                            onChange={(e) =>
                              handleInputChange(e, "away", player.id, "starter")
                            }
                          />
                        </td>
                        <td>
                          <input
                            ...
                            name="goals"
                            onChange={(e) =>
                              handleInputChange(e, "away", player.id, "goals")
                            }
                            className="stats-input"
                          />
                        </td>
                        <td>
                          <input
                            ...
                            name="assists"
                            onChange={(e) =>
                              handleInputChange(e, "away", player.id, "assists")
                            }
                            className="stats-input"
                          />
                        </td>
                        ...
                        <td>
                          <input
                            ...
                            name="minutes"
                            onChange={(e) =>
                              handleInputChange(e, "away", player.id, "minutes")
                            }
                            className="minutes-input"
                            list="minutes-options"
                          />
